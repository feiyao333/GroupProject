...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-9">
			...
			<caption><font color="#000000">Technology Textbook</font></caption>
		...
		<tbody>
			<?php
				...
				$tableName = "Item";	
				$sql = "select *from Item where title LIKE 'Tec%';";
				$stmt = sqlsrv_query($conn, $sql);
				while($row = sqlsrv_fetch_array($stmt)){
					echo"
					<tr>
						<td><input type='checkBox' name='index[]' value='10'></td>
						<td><image src='images/technology/$row[2].jpg' class='pic'></td>
						<td>$row[0]</td>
						<td>$row[1]</td>
						<td>$row[3]</td>
